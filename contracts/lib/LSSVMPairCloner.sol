...
library PIKOSYSPairCloner {
    ...
    function cloneETHPair(
        ...
        IPIKOSYSPairFactoryLike factory,
        ICurve bondingCurve,
        IERC721 nft,
        uint8 poolType
    ...
    /**
     * @notice Checks if a contract is a clone of a PIKOSYSPairETH.
     * @dev Only checks the runtime bytecode, does not check the extra data.
     * @param factory the factory that deployed the clone
     * @param implementation the PIKOSYSPairETH implementation contract
    ...
    /**
     * @notice Checks if a contract is a clone of a PIKOSYSPairERC20.
     * @dev Only checks the runtime bytecode, does not check the extra data.
     * @param implementation the PIKOSYSPairERC20 implementation contract
     * @param query the contract to check
     * @return result True if the contract is a clone, false otherwise
     */

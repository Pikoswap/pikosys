...
contract PIKOSYSRouter {
    ...
    IPIKOSYSPairFactoryLike public immutable factory;

    constructor(IPIKOSYSPairFactoryLike _factory) {
        factory = _factory;
    }
    ...
    function pairTransferERC20From(
        ...
        address to,
        uint256 amount,
        IPIKOSYSPairFactoryLike.PairVariant variant
    ) external {
        ...
        require(
            variant == IPIKOSYSPairFactoryLike.PairVariant.ENUMERABLE_ERC20 ||
            variant ==
            IPIKOSYSPairFactoryLike.PairVariant.MISSING_ENUMERABLE_ERC20,
            "Not ERC20 pair"
        );
